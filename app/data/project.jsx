export const projects = [
  {
    ...
    title: "Pure Clay ",
    description:
      "An e-commerce platform for organic food and skincare products with brand storytelling and educational content.",
    ...
    testimonial: {
      quote:
        "We were managing all orders manually through Instagram DMs it was chaos. Now with the automated website, customers order directly and we save hours of work every day.",
  ...
  },
  {
    ...
    title: "TimeXperts",
    description:
      "A professional corporate website for a global IT outsourcing partner, featuring modern UI/UX design, service showcases, and lead generation tools.",
    ...
    testimonial: {
      quote:
        "Our old website was outdated and wasn't bringing in quality leads. The new site clearly showcases our 18+ years of expertise and has made it easy for global clients to understand and contact us.",
      author: "Team",
  ...
  },
  {
    ...
    title: "Natura Bliss",
    description:
      "Pakistan's first all-natural personal care brand with an e-commerce platform featuring handmade products, brand storytelling, and educational content.",
    ...
    testimonial: {
      quote:
        "The new website has completely transformed how we sell our products. No more taking orders manually on Instagram  everything is automated and our customers love the seamless shopping experience.",
...

  {
    ...
    title: "SZ Naturals",
    description:
      "An e-commerce platform for herbal hair care products featuring ancient Ayurvedic ingredients, brand storytelling, and customer reviews.",
