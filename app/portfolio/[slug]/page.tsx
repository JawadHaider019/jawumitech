...
import { ArrowLeft, ExternalLink, CheckCircle, Award, Clock, Users, TrendingUp, } from 'lucide-react';
import { FaStar} from 'react-icons/fa';
import { getProjectBySlug, getAllProjectSlugs, projects } from '../../data/project';
          ...
          <div className="grid grid-cols-1  gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-8">
                <div>
                  <span className="text-sm text-gray-400 block mb-1">Client</span>
                  <span className="text-lg font-semibold">{project.client}</span>
                </div>
                <div>
                  <span className="text-sm text-gray-400 block mb-1">Live Link</span>
                  <a 
 ...
 <p className="text-gray-400 text-lg max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-[#0a0a0a] overflow-hidden relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap justify-center gap-8 max-w-4xl">
              {project.technologies.map((tech, i) => {
                ...
                return (
                  ...
                  >
                    <div className={`text-5xl md:text-6xl ${techInfo.color} transition-all duration-300 group-hover:scale-110 group-hover:-translate-y-2`}>
                      <IconComponent />
                    </div>
          ...
          {project.technologies.filter(tech => techIconMap[tech]).length === 0 && (
            <div className="text-center text-gray-400">
              <p>No matching technologies from our stack were used in this project.</p>
            </div>
          )}
          ...
          {project.technologies.filter(tech => techIconMap[tech]).length > 0 && (
            <div className="mt-16 relative h-20">
              <div className="absolute inset-0 flex items-center justify-center gap-3 opacity-20">
                {project.technologies.filter(tech => techIconMap[tech]).slice(0, 7).map((_, i) => (
                  <div 
                    key={i}
