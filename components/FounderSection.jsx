...
const FounderSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-16 sm:py-20 lg:min-h-screen lg:flex lg:items-center lg:justify-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-black"
    >
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-1 xl:grid-cols-12 gap-8 lg:gap-12 items-start">
              ...
              <div className="relative bg-gradient-to-br from-[#0A0A0A] to-[#1A1A1A] rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-4 border border-white/10 backdrop-blur-sm overflow-hidden">
                ...
                <div className="relative rounded-lg sm:rounded-xl overflow-hidden">
                  <Image
                    ...
                    width={600}
                    height={600}
                    className={`w-full h-auto object-cover transition-all duration-500 ${imageLoaded ? "scale-100 blur-0" : "scale-105 blur-sm"
          ...
          >
            ...
            >
              <p>
                With several years of hands-on experience in full-stack
                development, I’ve dedicated my career to turning ideas into
                reliable, efficient digital solutions. I started with a passion
                for technology and a belief that every business, big or small,
                deserves access to smart, well-designed software.
              </p>

              <p>
                My approach combines deep technical expertise with practical
                problem-solving. I craft scalable applications and systems that
                help growing businesses achieve measurable results.
              </p>
            </motion.div>
              ...
              <div className="flex items-start gap-3 ">
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <p className="text-gray-300 leading-relaxed text-md ">
                    Building digital ecosystems where technology works
                    seamlessly — optimizing workflows, enhancing efficiency, and
                    empowering businesses to grow confidently.
                  </p>
                </div>
              </div>
            </motion.div>
