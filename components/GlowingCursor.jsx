  ...
  useEffect(() => {
    ...
    const handleMouseDown = () => {
      if (cursorRef.current) {
        ...
        cursorRef.current.style.background =
          "radial-gradient(circle, rgba(191,247,71,0.8) 0%, rgba(191,247,71,0.4) 50%, rgba(191,247,71,0.2) 70%, transparent 100%)";
      }
    };
    ...
    const handleMouseUp = () => {
      if (cursorRef.current) {
        ...
        cursorRef.current.style.background =
          "radial-gradient(circle, rgba(191,247,71,0.6) 0%, rgba(191,247,71,0.3) 50%, rgba(191,247,71,0.1) 70%, transparent 100%)";
      }
    };
    ...
    const handleMouseOver = (e) => {
      ...
      if (
        ...
        if (cursorRef.current) {
          ...
          cursorRef.current.style.background =
            "radial-gradient(circle, rgba(191,247,71,0.9) 0%, rgba(191,247,71,0.5) 50%, rgba(191,247,71,0.2) 70%, transparent 100%)";
          cursorRef.current.style.filter =
            "blur(0.5px) drop-shadow(0 0 15px #bff747) drop-shadow(0 0 25px #bff747)";
        }
      }
    };
      ...
      if (
        ...
        if (cursorRef.current) {
          ...
          cursorRef.current.style.background =
            "radial-gradient(circle, rgba(191,247,71,0.6) 0%, rgba(191,247,71,0.3) 50%, rgba(191,247,71,0.1) 70%, transparent 100%)";
          cursorRef.current.style.filter =
            "blur(0.5px) drop-shadow(0 0 10px #bff747) drop-shadow(0 0 20px #bff747)";
        }
      }
    };
