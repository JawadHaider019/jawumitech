...
export function AboutSection() {
  ...
  const text = "At Jawumitech, we help businesses build custom online stores and digital platforms designed for growth. We create fast, scalable, and easy-to-manage solutions that give brands full control over their business and customer experience.";
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-16">
          <div className="lg:col-span-3">
            <span className="text-lg font-bold text-gray-500 uppercase pl-10 pt-10">Who We Are</span>
          </div>
          <div className="lg:col-span-9">
            <h2 className="text-3xl md:text-4xl  font-medium leading-[1.3] tracking-tight flex flex-wrap gap-x-[0.25em] gap-y-1">
              {words.map((word, i) => (
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-end">
          ...
          {/* CTA Text & Button */}
          <div className="lg:col-span-4 pb-10 flex flex-col justify-end">
            <div className="mb-12 space-y-4">
              {[
                ...
                >
                  ...
                  <span className="text-gray-600 font-semibold text-base lg:text-lg group-hover:text-black transition-colors duration-300">
                    {item}
                  </span>
                </motion.div>
              ))}
            ...
            >
              <h3 className="text-2xl font-bold leading-tight">
                Our Bold and <br /> Brilliant Thinkers
              </h3>
              <Link
                href="/about"
