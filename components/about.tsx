...
export function About() {
  ...
  return (
    <section className="relative py-12 sm:py-16 lg:py-20 bg-black text-white overflow-hidden">
          ...
          <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              {stats.map((stat, index) => (
                <div 
                  key={index}
                  className={`p-3 sm:p-4 rounded-xl sm:rounded-2xl border transition-all duration-500 cursor-pointer ${
                    activeStat === index 
