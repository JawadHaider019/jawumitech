...
const teamMembers = [
  {
    ...
    description:
      "Leads the company’s vision and direction while contributing as a full-stack developer. Ensures high technical standards and delivers top-quality solutions.",
  },
  {
    name: "Aqib Mansoor",
    ...
    description:
      "Builds scalable web applications with a focus on smooth user experiences and reliable, high-quality solutions that meet client needs.",
  },
  {
    ...
    description:
      "Develops custom software solutions to improve business efficiency, with a focus on reliability, performance, and client satisfaction.",
  },
  {
    ...
    description:
      "Oversees projects from planning to delivery, ensuring smooth team coordination, timely execution, and consistent communication with clients.",
  },
];
          ...
          {teamMembers.map((member, i) => (
            ...
            >
              ...
              <div className="text-center leading-tight w-full">
                <motion.h3 className="text-lg sm:text-xl font-bold uppercase tracking-wide mb-1 sm:mb-2">
                  {member.name}
                </motion.h3>
                <motion.p className="text-[#bff747] text-xs sm:text-sm uppercase tracking-wider font-semibold">
                  {member.position}
                </motion.p>
              </div>
